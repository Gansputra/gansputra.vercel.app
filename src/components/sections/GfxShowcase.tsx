...
export const GfxShowcase = () => {
    ...
    return (
        <section id="gfx" className="py-24 px-6 relative overflow-hidden bg-black/50">
            {/* Background element */}
            ...
            <div className="max-w-7xl mx-auto">
                ...
                >
                    <a
                        ...
                        className="group relative flex items-center gap-3 px-8 py-4 bg-[#E60023]/10 hover:bg-[#E60023] border border-[#E60023]/20 text-white rounded-full transition-all duration-500 shadow-lg hover:shadow-[#E60023]/40"
                    >
                        <div className="bg-[#E60023] p-2 rounded-full group-hover:bg-white group-hover:text-[#E60023] transition-colors">
                            <svg
                                viewBox="0 0 24 24"
                                width="20"
                                height="20"
